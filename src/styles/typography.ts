...
export const SEMANTIC_STYLES: Record<string, TypographyStyle> = {
  ...
  "dua-pronunciation": {
    ...
    className: "dua-pronunciation text-[16px] sm:text-[17px] font-medium leading-[1.6] text-zinc-750 dark:text-zinc-200 mb-3 font-bengali",
  },
  "dua-meaning": {
    id: "dua-meaning",
    ...
    lineHeight: "leading-[1.6]",
    className: "dua-meaning text-[15px] sm:text-[16px] font-normal leading-[1.6] text-zinc-900 dark:text-zinc-100 pl-3.5 pr-3 py-2.5 my-3 border-l-[3px] border-[#ffb31a] bg-amber-500/8 dark:bg-amber-400/10 rounded-r-[12px] font-bengali shadow-2xs",
  },
  "dua-paragraph": {
    id: "dua-paragraph",
    ...
    fontWeight: "font-normal",
    lineHeight: "leading-[1.6]",
    className: "dua-paragraph text-[14.5px] sm:text-[15.5px] font-normal leading-[1.6] text-zinc-600 dark:text-zinc-400 mt-2.5 mb-2 font-bengali",
  },
};
