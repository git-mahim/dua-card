...
const TRANSLATIONS: Record<Language, Record<string, string>> = {
  bn: {
    ...
    lightMode: "লাইট মোড",
    darkMode: "ডার্ক মোড",
    googleProfileTitle: "গুগল অ্যাকাউন্ট ও ক্লাউড সিঙ্ক",
    connected: "সংযুক্ত",
    notConnected: "সংযুক্ত নেই",
    lastSynced: "সর্বশেষ সিঙ্ক / আপডেট:",
    syncNow: "সিঙ্ক করুন",
    logout: "লগআউট",
    signInWithGoogle: "গুগল (Gmail) দিয়ে সাইন-ইন করুন",
    googleAuthDesc: "আপনার গুগল অ্যাকাউন্ট দিয়ে ১-ক্লিকে লগইন করে সকল ডিভাইসে দোয়া অটোমেটিক ব্যাকআপ রাখুন।",
  ...
  en: {
    ...
    lightMode: "Light",
    darkMode: "Dark",
    googleProfileTitle: "Google Account & Cloud Sync",
    connected: "Connected",
    ...
    googleAuthDesc: "Sign in with Google in 1-click for automatic cloud backup across all your devices.",
