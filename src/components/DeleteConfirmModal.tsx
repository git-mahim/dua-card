...
export const DeleteConfirmModal: React.FC<DeleteConfirmModalProps> = ({
  ...
  return (
    ...
    >
      <div className="w-full max-w-sm bg-white dark:bg-[#141414] border border-zinc-200 dark:border-zinc-800 rounded-2xl p-5 shadow-xl font-bengali text-left flex flex-col gap-4">
