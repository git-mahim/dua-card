...
export const DuaCard: React.FC<DuaCardProps> = ({
  ...
  return (
    ...
    >
              ...
              {showMenu && (
                <>
                  ...
                  <div className="absolute right-0 top-7 z-50 w-44 bg-white dark:bg-[#1a1a1a] border border-zinc-200 dark:border-zinc-800 rounded-2xl shadow-xl py-1 text-xs font-bengali animate-in fade-in zoom-in-95 duration-100 divide-y divide-zinc-100 dark:divide-zinc-800/60">
                    ...
                    <div className="py-1">
                      {/* আমল হিস্ট্রি ও চার্ট (Analytics) */}
                      {onOpenAnalytics && (
                        <button
                          type="button"
                          onClick={(e) => {
                        ...
                        >
                          ...
                          <span>আমল হিস্ট্রি ও চার্ট</span>
                        </button>
                      )}
      ...
      {/* Bottom Action Footer: Analytics Shortcut Button & Quick Dhikr Counter Pill */}
      {!isDragOverlay && (
        <div
        ...
        >
          {/* Direct "আমল হিস্ট্রি ও চার্ট" Button */}
          {onOpenAnalytics && (
            <button
              type="button"
              onClick={() => {
              ...
              className="flex items-center gap-1.5 px-2.5 py-1 text-xs font-semibold font-bengali text-zinc-700 dark:text-zinc-300 hover:text-zinc-950 dark:hover:text-zinc-100 hover:bg-zinc-100 dark:hover:bg-zinc-800/80 active:scale-95 rounded-xl border border-zinc-200/70 dark:border-zinc-700/70 transition-all shadow-2xs"
