      ...
      >
          ...
          <div className="grid grid-cols-4 gap-2">
            {[33, 100, 500, 1000].map((amt) => (
              <button
                ...
                className="min-h-[44px] py-2 px-1.5 bg-zinc-100 dark:bg-zinc-800/90 hover:bg-[#ffb31a] hover:text-zinc-950 dark:hover:bg-[#ffb31a] dark:hover:text-zinc-950 active:scale-95 text-zinc-800 dark:text-zinc-200 rounded-[12px] text-xs font-bold font-bengali border border-zinc-200/80 dark:border-zinc-700/80 transition-all flex items-center justify-center gap-1 shadow-2xs"
              >
        ...
        <div className="flex flex-col gap-2 pt-0.5">
          ...
          <form onSubmit={handleCustomAddSubmit} className="flex items-center gap-2">
            ...
            <button
              ...
              className="min-h-[44px] px-3.5 py-2 bg-[#ffb31a] hover:bg-[#e69c05] disabled:bg-zinc-200 dark:disabled:bg-zinc-800 disabled:text-zinc-400 disabled:cursor-not-allowed text-zinc-950 text-xs font-bold font-bengali rounded-[12px] transition-all shadow-xs active:scale-95 flex items-center gap-1.5 shrink-0 whitespace-nowrap"
            >
        ...
        <div className="grid grid-cols-2 gap-2 pt-1">
          <button
            ...
            className="min-h-[44px] py-2.5 px-3 bg-zinc-100 dark:bg-zinc-800/80 hover:bg-zinc-200/80 dark:hover:bg-zinc-700/80 text-zinc-700 dark:text-zinc-300 border border-zinc-200 dark:border-zinc-700/80 rounded-[12px] text-xs font-bold font-bengali transition-colors flex items-center justify-center gap-2 disabled:opacity-40 disabled:cursor-not-allowed shadow-2xs active:scale-95"
          ...
          <button
            type="button"
            onClick={onClose}
            className="min-h-[44px] py-2.5 px-3 bg-[#ffb31a] hover:bg-[#e69c05] text-zinc-950 rounded-[12px] text-xs font-bold font-bengali transition-all shadow-xs active:scale-95 flex items-center justify-center gap-1.5"
          >
