...
export const InstallPwaPrompt: React.FC = () => {
  ...
  const handleInstallClick = async () => {
    if (deferredPrompt) {
      ...
      // Toggle manual instructions for Android Chrome / mobile
  ...
  return (
    <aside
      ...
      className="w-full mb-4 p-3.5 bg-[#ffb31a]/10 dark:bg-[#ffb31a]/15 border border-[#ffb31a]/25 dark:border-[#ffb31a]/30 rounded-2xl flex flex-col gap-2 font-bengali text-xs transition-all"
    >
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2 text-zinc-900 dark:text-zinc-100 font-bold">
          ...
          <span>ফোনে অ্যাপ হিসেবে ইনস্টল করুন</span>
        </div>
        <div className="flex items-center gap-1.5">
          ...
          >
            {deferredPrompt ? "ইনস্টল করুন" : "কীভাবে ইনস্টল করবেন?"}
          </button>
          <button
            type="button"
